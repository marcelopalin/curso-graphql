...
# Acompanhe todas as consultas em testes/consultas.js

Todo o aprendizado de consultas está documentado em **consulta.js**

# ALTERAR

O update será db('tabela').where({id: 1}).update(novoUsuario)

VAMOS UTILIZAR - ASYNC AWAIT para fazer isto!

A função ESPERA antes de passar para a próxima linha.

Só para termos referência:
